...
export default function CategoryOneSlider({ Categories, Loading, general }) {
  // let general = [];
  //general = JSON.parse(localStorage.getItem("general_set"));
    ...
    <div>
      ...
      >
        ...
        >
          {!Loading
            ? Categories.map((item) => (
                <div className="blog-wrap mb-30 scroll-zoom ml-3" key={item.id}>
